...
Begin VB.Form Setupfrm 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox ComboGuiding 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":126F
         Left            =   120
         List            =   "Setupfrm.frx":1279
         Style           =   2  'Dropdown List
         TabIndex        =   61
         ToolTipText     =   "Choose your guiding method."
         Top             =   240
         Width           =   2865
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CommandSaveSite 
         BackColor       =   &H0095C1CB&
         DisabledPicture =   "Setupfrm.frx":1E1B
         BeginProperty Font 
            Name            =   "Arial Narrow"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.ComboBox cbhem 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "Setupfrm.frx":291F
         Left            =   1320
         List            =   "Setupfrm.frx":2929
         Style           =   2  'Dropdown List
         TabIndex        =   23
         Top             =   2280
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cbEW 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":293B
         Left            =   1320
         List            =   "Setupfrm.frx":2945
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   1320
         Width           =   555
      ...
      Begin VB.ComboBox cbNS 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":294F
         Left            =   1320
         List            =   "Setupfrm.frx":2959
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   915
         Width           =   555
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox ComboLanguage 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":2EE5
         Left            =   120
         List            =   "Setupfrm.frx":2EEF
         Style           =   2  'Dropdown List
         TabIndex        =   54
         Top             =   1560
         Width           =   2295
      ...
      Begin VB.ComboBox ComboUpdateMode 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":2F0E
         Left            =   6000
         List            =   "Setupfrm.frx":2F1B
         Style           =   2  'Dropdown List
         TabIndex        =   52
         Top             =   840
         Width           =   2295
      ...
      Begin VB.ComboBox ComboProcessPriority 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":2F47
         Left            =   120
         List            =   "Setupfrm.frx":2F57
         Style           =   2  'Dropdown List
         TabIndex        =   50
         Top             =   840
         Width           =   2295
      ...
      Begin VB.ComboBox Combo2 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":2F7C
         Left            =   3840
         List            =   "Setupfrm.frx":2F9E
         Style           =   2  'Dropdown List
         TabIndex        =   34
         Top             =   720
         Width           =   615
   ...
   Begin VB.Frame FrameAscom 
      ...
      Top             =   1080
      Width           =   2775
      Begin VB.CheckBox CheckStrict 
         BackColor       =   &H00000000&
         Caption         =   "Strict Conformance"
         ForeColor       =   &H000080FF&
         Height          =   255
         Left            =   120
         TabIndex        =   67
         ...
         Width           =   2295
      End
      Begin VB.ComboBox ComboPierSide 
         BackColor       =   &H00000080&
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":2FC1
         Left            =   960
         List            =   "Setupfrm.frx":2FD1
         Style           =   2  'Dropdown List
         TabIndex        =   65
         ToolTipText     =   """Pointing"" and ""None"" are the only ASCOM compliant methods."
         Top             =   1800
         Width           =   1695
      End
      Begin VB.ComboBox ComboEPOCH 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":3007
         Left            =   120
         List            =   "Setupfrm.frx":301A
         Style           =   2  'Dropdown List
         TabIndex        =   62
         ToolTipText     =   "Sets the EPOCH EQASCOM wil report to clients, if asked."
         Top             =   2400
         Width           =   2535
      End
      Begin VB.CheckBox CheckSiteWrites 
         ...
         Left            =   120
         TabIndex        =   59
         ToolTipText     =   "Allows client applications to change the site data (not reccomended)"
         Top             =   720
         Width           =   2295
      End
      Begin VB.CheckBox ChkBlockPark 
         ...
         Left            =   120
         TabIndex        =   49
         ToolTipText     =   "Only returns control to the client once a park has completed."
         Top             =   480
         Width           =   2295
      End
      Begin VB.CheckBox ChkPulseErrs 
         ...
         Left            =   120
         TabIndex        =   29
         ToolTipText     =   "Only uncheck  if your guiding application isn't handling ASCOM pulseguide exceptions."
         Top             =   1200
         Width           =   2295
      End
      Begin VB.CheckBox ChkExceptions 
         ...
         Left            =   120
         TabIndex        =   28
         ToolTipText     =   "Only uncheck if a client application isn't handling ASCOM exceptions."
         Top             =   960
         Width           =   2295
      End
   ...
   Begin VB.PictureBox picASCOM 
      ...
      Height          =   840
      Left            =   120
      MouseIcon       =   "Setupfrm.frx":3048
      MousePointer    =   99  'Custom
      Picture         =   "Setupfrm.frx":319A
      ScaleHeight     =   840
      ScaleWidth      =   840
      TabIndex        =   13
      Top             =   120
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox lbRetry 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":5D0E
         Left            =   1320
         List            =   "Setupfrm.frx":5D18
         Style           =   2  'Dropdown List
         TabIndex        =   20
         Top             =   720
         Width           =   945
      ...
      Begin VB.ComboBox lbTimeout 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":5D22
         Left            =   1320
         List            =   "Setupfrm.frx":5D2C
         Style           =   2  'Dropdown List
         TabIndex        =   18
         Top             =   240
         Width           =   945
      ...
      Begin VB.ComboBox lbBaud 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":5D3C
         Left            =   1320
         List            =   "Setupfrm.frx":5D4C
         Style           =   2  'Dropdown List
         TabIndex        =   16
         Top             =   1200
         Width           =   945
      ...
      Begin VB.ComboBox lbPort 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "Setupfrm.frx":5D6C
         Left            =   1320
         List            =   "Setupfrm.frx":5DA0
         Style           =   2  'Dropdown List
         TabIndex        =   11
         Top             =   2160
         Width           =   945
...
Private Sub CheckAdvanced_Click()
    ...
    If CheckAdvanced.Value = 1 Then
        ' ComboPierSide.Enabled = True
    Else
        ' ComboPierSide.Enabled = False
    End If
End Sub


Private Sub CheckStrict_Click()
    If CheckStrict.Value = 0 Then
        ChkPulseErrs.Visible = True
        ChkExceptions.Visible = True
        Label19.Visible = True
        ComboPierSide.Visible = True
    Else
        ChkPulseErrs.Value = 1
        ChkPulseErrs.Visible = False
        ChkExceptions.Value = 1
        ChkExceptions.Visible = False
        Label19.Visible = False
        ComboPierSide.ListIndex = 0
        ComboPierSide.Visible = False
    End If
End Sub
...
Private Sub ComboMount_Click()
    Select Case ComboMount.ListIndex
       Case 0
            gCustomMount = 0
...
Private Sub Commandcustomise_Click()
    ...
    If gCustomMount = 0 Then
        ComboMount.ListIndex = 0
        Commandcustomise.Visible = False
    Else
        ComboMount.ListIndex = 1
        Commandcustomise.Visible = True
    End If
End Sub
...
Private Sub CommandOK_Click()
    ...
    gAscomCompatibility.SideOfPier = ComboPierSide.ListIndex
    ...
    elev = CDbl(EQFixNum(Setupfrm.txtElevation))
...
'    If tmptxt <> "" Then Setupfrm.cbhem.ListIndex = val(tmptxt)
    ...
    ComboPierSide.ListIndex = gAscomCompatibility.SideOfPier
