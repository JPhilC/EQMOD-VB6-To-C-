...
Dim flipped As Boolean
    ...
    With AlignmentStars(curalign)
      ...
      DeltaRa = .TargetRA - .EncoderRA     ''  Difference between theoretical position and encode position.
      DeltaDec = .TargetDEC - .EncoderDEC  ''  Difference between theoretical position and encode position.
