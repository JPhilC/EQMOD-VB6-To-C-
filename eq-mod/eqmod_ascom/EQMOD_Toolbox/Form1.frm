...
Dim id As String
    ...
    If CommandConnect.Caption = "ASCOM Connect" Then
...
'        End Select
        ...
        If Not gscope Is Nothing Then
            CommandConnect.Caption = "ASCOM Disconnect"
    ...
    Else
        ...
        If Not gscope Is Nothing Then
            ...
            If Not gscope.Connected Then
                Set gscope = Nothing
                CommandConnect.Caption = "ASCOM Connect"
            End If
        End If
    End If
