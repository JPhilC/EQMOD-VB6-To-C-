...
Begin VB.Form HC 
   ...
   Begin VB.Frame Frame10 
      BackColor       =   &H00000000&
      Caption         =   "Development Testing Area"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H000080FF&
         Height          =   345
         ItemData        =   "HCsmall.frx":0CCA
         Left            =   120
         List            =   "HCsmall.frx":0CD4
      ...
      Begin VB.CommandButton Command1 
         ...
         Width           =   495
      End
      Begin VB.HScrollBar HScrollPolarLed 
         Height          =   135
         Left            =   120
         Max             =   250
         TabIndex        =   249
      ...
      Begin VB.CommandButton Command1 
         ...
         Index           =   1
         Left            =   1320
         Picture         =   "HCsmall.frx":0CFB
         Style           =   1  'Graphical
         TabIndex        =   247
         TabStop         =   0   'False
         ToolTipText     =   "Append to current log"
         Top             =   4320
         Width           =   375
      End
      Begin VB.CommandButton Command1 
         ...
         Index           =   2
         Left            =   1680
         Picture         =   "HCsmall.frx":103D
         Style           =   1  'Graphical
         TabIndex        =   246
         TabStop         =   0   'False
         ToolTipText     =   "Pause Current Log"
         Top             =   4320
         Width           =   375
      End
      Begin VB.CommandButton Command1 
   ...
   Begin VB.Frame TrackingFrame 
      ...
      Begin VB.CommandButton CmdTrack 
         BackColor       =   &H0095C1CB&
         DisabledPicture =   "HCsmall.frx":322D
         BeginProperty Font 
            Name            =   "Arial Narrow"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox ComboActivePoints 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "HCsmall.frx":5E3D
         Left            =   120
         List            =   "HCsmall.frx":5E4A
         Style           =   2  'Dropdown List
         TabIndex        =   162
         Top             =   2760
         Width           =   1695
      ...
      Begin VB.ComboBox Combo3PointAlgorithm 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "HCsmall.frx":5E80
         Left            =   2040
         List            =   "HCsmall.frx":5E8A
         Style           =   2  'Dropdown List
         TabIndex        =   161
         Top             =   2760
         Width           =   1695
      ...
      Begin VB.ComboBox ListSyncMode 
         ...
         ForeColor       =   &H000080FF&
         Height          =   345
         ItemData        =   "HCsmall.frx":642D
         Left            =   120
         List            =   "HCsmall.frx":642F
         Style           =   2  'Dropdown List
         TabIndex        =   94
         Top             =   1560
         Width           =   1695
      ...
      Begin VB.ComboBox ListAlignMode 
         ...
         ForeColor       =   &H000080FF&
         Height          =   345
         ItemData        =   "HCsmall.frx":6431
         Left            =   2040
         List            =   "HCsmall.frx":6433
         Style           =   2  'Dropdown List
         TabIndex        =   92
         Top             =   1560
         Width           =   1695
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox ComboPark 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "HCsmall.frx":7FBF
         Left            =   120
         List            =   "HCsmall.frx":7FC1
         Style           =   2  'Dropdown List
         TabIndex        =   103
         Top             =   480
         Width           =   3015
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox ComboPoleStar 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "HCsmall.frx":8545
         Left            =   2640
         List            =   "HCsmall.frx":8558
         Style           =   2  'Dropdown List
         TabIndex        =   206
         Top             =   2040
         Width           =   975
      ...
      Begin VB.CommandButton CommandSaveSite 
         BackColor       =   &H0095C1CB&
         DisabledPicture =   "HCsmall.frx":8589
         BeginProperty Font 
            Name            =   "Arial Narrow"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.ComboBox cbNS 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "HCsmall.frx":9C11
         Left            =   1560
         List            =   "HCsmall.frx":9C1B
         Style           =   2  'Dropdown List
         TabIndex        =   41
         TabStop         =   0   'False
         Top             =   600
      ...
      Begin VB.ComboBox cbEW 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "HCsmall.frx":9C25
         Left            =   1560
         List            =   "HCsmall.frx":9C2F
         Style           =   2  'Dropdown List
         TabIndex        =   44
         TabStop         =   0   'False
         Top             =   945
   ...
   Begin VB.PictureBox picASCOM 
      ...
      Height          =   720
      Left            =   120
      MouseIcon       =   "HCsmall.frx":9C39
      Picture         =   "HCsmall.frx":9D8B
      ScaleHeight     =   720
      ScaleWidth      =   720
      TabIndex        =   53
      Top             =   80
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.ComboBox DECGuideRateList 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "HCsmall.frx":C3D1
         Left            =   240
         List            =   "HCsmall.frx":C3E4
         Style           =   2  'Dropdown List
         TabIndex        =   77
         Top             =   1320
         Width           =   1095
      ...
      Begin VB.ComboBox RAGuideRateList 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "HCsmall.frx":C40E
         Left            =   240
         List            =   "HCsmall.frx":C421
         Style           =   2  'Dropdown List
         TabIndex        =   76
         Top             =   600
         Width           =   1095
   ...
   Begin VB.Frame SlewFrame 
      ...
      Begin VB.ComboBox PresetRateCombo 
         ...
         ForeColor       =   &H000080FF&
         Height          =   345
         ItemData        =   "HCsmall.frx":D5C1
         Left            =   1912
         List            =   "HCsmall.frx":D5C8
         Style           =   2  'Dropdown List
         TabIndex        =   18
         Top             =   840
         Width           =   555
   ...
   Begin VB.Frame PositionFrame 
      ...
      Begin VB.Label lstmrk 
         ...
         Left            =   120
         TabIndex        =   6
         ToolTipText     =   """Click for Air Mass"""
         Top             =   240
         Width           =   975
      End
   ...
   Begin VB.Frame Slew2Frame 
      ...
      Begin VB.ComboBox PresetRate2Combo 
         ...
         ForeColor       =   &H000080FF&
         Height          =   345
         ItemData        =   "HCsmall.frx":DB66
         Left            =   1560
         List            =   "HCsmall.frx":DB6D
         Style           =   2  'Dropdown List
         TabIndex        =   216
         Top             =   1320
         Width           =   555
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.CommandButton CmdPecSave 
            BackColor       =   &H0095C1CB&
            DisabledPicture =   "HCsmall.frx":10311
            BeginProperty Font 
               Name            =   "Arial Narrow"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.ComboBox cbhem 
         ...
         ForeColor       =   &H000080FF&
         Height          =   315
         ItemData        =   "HCsmall.frx":1150D
         Left            =   1320
         List            =   "HCsmall.frx":11517
         Style           =   2  'Dropdown List
         TabIndex        =   241
         TabStop         =   0   'False
         Top             =   1080
...
Private CommsLogFile As String
Private CommsLogState As Integer
...
Private Sub Combo1_Click()
   Dim res As Long
    ...
    Select Case Combo1.ListIndex
        Case 0
            res = EQ_WP(2, 10004, 1)
            Call oPersist.WriteIniValue("ENABLE_HW_ENCODERS", "0")
        Case 1
            res = EQ_WP(2, 10004, 0)
            Call oPersist.WriteIniValue("ENABLE_HW_ENCODERS", "1")
    End Select
...
Private Sub Command1_Click(Index As Integer)
    ...
    Select Case Index
        Case 0
            ...
            Select Case res
                Case 0
                    Label5(4).Caption = "PPEC is OFF"
                Case 1, 3
                    Label5(4).Caption = "PPEC is Training"
                Case 2
                    Label5(4).Caption = "PPEC is ON"
                Case Else
                    Label5(4).Caption = "----"
            End Select
        ...
        Case 1
            ' Record
            If CommsLogFile = "" Then
                CommsLogState = 0
                CommonDialog1.filter = "Comms Trace Files{*.txt)|*.txt"
                CommonDialog1.FileName = oPersist.GetIniPath() & "\comms_trace.txt"
                CommonDialog1.ShowSave
                If CommonDialog1.FileName <> "" Then
                    CommsLogFile = CommonDialog1.FileName
                    res = EQ_DebugLog(CommsLogFile, "start", 1)
                    'res = EQ_DebugLog(oPersist.GetIniPath() & "\comms_trace.txt", "start", 1)
                    Command1(1).Picture = LoadResPicture(106, vbResBitmap) ' record bright
                    Command1(2).Picture = LoadResPicture(113, vbResBitmap) ' pause dim
                    CommsLogState = 1
                End If
            End If
        ...
        Case 2
            ' pause
            If CommsLogFile <> "" Then
                Select Case CommsLogState
                    Case 0
                    Case 1
                        ' recording
                        res = EQ_DebugLog("", "", 0)
                        Command1(1).Picture = LoadResPicture(115, vbResBitmap) ' record dim
                        Command1(2).Picture = LoadResPicture(109, vbResBitmap) ' pause bright
                        CommsLogState = 2 ' paused.
                    Case 2
                        ' paused
                        CommentDlg.Show (1)
                        res = EQ_DebugLog(CommsLogFile, CommentDlg.strComment, 2)
                        Command1(1).Picture = LoadResPicture(106, vbResBitmap) ' record bright
                        Command1(2).Picture = LoadResPicture(113, vbResBitmap) ' pause dim
                        CommsLogState = 1 ' now recording
                End Select

            End If
        Case 3
            res = EQ_WP(0, 10006, HScrollPolarLed.Value)
            
        Case 4
            res = EQ_End()
            ' get feature set
            strtmp = "\\.\" & gPort
            res = EQ_Init(strtmp, gBaud, gTimeout, gRetry)
            gMount_Features = EQ_GetMountFeatures()
            ' update display based on feature set
...
Private Sub HScrollPolarLed_Change()
    Label5(0).Caption = CStr(HScrollPolarLed.Value)
    HC.oPersist.WriteIniValue "POLAR_SCOPE_BRIGHTNESS", CStr(HC.HScrollPolarLed.Value)
End Sub

Private Sub HScrollPolarLed_Scroll()
    Call HScrollPolarLed_Change
End Sub
...
Private Sub lstlbl_Click()
    Call lstmrk_Click
End Sub

Private Sub lstmrk_Click()
    gLstDisplayMode = gLstDisplayMode + 1
    If gLstDisplayMode > 1 Then
        gLstDisplayMode = 0
    End If
    HC.oPersist.WriteIniValue "LST_DISPLAY_MODE", CStr(gLstDisplayMode)
...
Private Sub DisplayTimer_Timer()
    ...
    Select Case gLstDisplayMode
        Case 0
            lstmrk.Caption = oLangDll.GetLangString(104)
            TmpLst = EQnow_lst(gLongitude * DEG_RAD)
            lstlbl.Caption = FmtSexa(TmpLst, False)
            lstmrk.ToolTipText = "Click for Air Mass"
        Case 1
            lstmrk.Caption = "AM"
            If gAlt >= 0 Then
                TmpLst = gAlt + 244 / (165 + 47 * gAlt ^ 1.1)
            Else
                TmpLst = 244 / 165
            End If
            TmpLst = 1 / Sin(degrad(TmpLst))
            lstlbl.Caption = FormatNumber(TmpLst, 3)
            lstmrk.ToolTipText = "Click for LST"
    End Select
...
'               If gEQDECPulseDuration <= 0 Then
'                   HC.Add_Message ("DecPulse = " & CStr(tick - gEQDECPulseStart) & "mS")
...
'                End If
                ...
                If tick > gEQRAPulseEnd Then
                    HC.Add_Message ("RAPulse = " & CStr(tick - gEQRAPulseStart) & "mS")
                    If gTrackingStatus <> 4 And (gRA_LastRate = 0) Then
                        eqres = EQ_SendGuideRate(0, gTrackingStatus - 1, 0, 0, gHemisphere, gHemisphere)
                    Else
                        Call ChangeRA_by_Rate(gRightAscensionRate)
