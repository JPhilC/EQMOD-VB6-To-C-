...
Begin VB.Form PECConfigFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox PECMethodCombo 
         ...
         ForeColor       =   &H000080FF&
         Height          =   330
         ItemData        =   "PECConfigFrm.frx":05BA
         Left            =   2640
         List            =   "PECConfigFrm.frx":05C4
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   360
         Width           =   1575
...
Private Sub Form_Load()
    ...
    Select Case gPEC_Capture_Cycles
        ...
        Case 5
            ComboPecCap.ListIndex = 4
        Case 4
            ComboPecCap.ListIndex = 5
        Case 3
            ComboPecCap.ListIndex = 6
        Case 2
            ComboPecCap.ListIndex = 7
        Case Else
    End Select
